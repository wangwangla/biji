...
@RequestMapping("/category/waregouse")
public class WaregouseCategoryController extends BaseController {
    @JbootrpcService
    private WaregouseCategoryService dataService;
    ...
    public void tableData() {
        ...
        Page<WaregouseCategory> dataPage = dataService.findPage(pageNumber, pageSize);
        renderJson(new DataTable<WaregouseCategory>(dataPage));
    }
